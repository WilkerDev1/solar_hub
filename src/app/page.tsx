...
export function DashboardShell({ children, defaultTab = 'dashboard' }: DashboardShellProps) {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-zinc-50 dark:bg-[#121315] text-zinc-800 dark:text-zinc-100 font-sans selection:bg-emerald-500 selection:text-black transition-colors duration-200">
      ...
      {sidebarVisible && (
        <aside 
          ...
          className="relative bg-zinc-100 dark:bg-[#1e1e24] border-r border-zinc-205 dark:border-[#2c2d34]/60 flex flex-col justify-between hidden md:flex shrink-0 z-30 transition-colors duration-200 h-full select-none"
        >
      ...
      <div className="flex-1 flex flex-col min-h-0 min-w-0 relative overflow-hidden">
        <header className="h-16 shrink-0 bg-white/80 dark:bg-[#1e1e24]/90 backdrop-blur-md border-b border-zinc-200 dark:border-[#2c2d34]/60 px-6 flex items-center justify-between z-20 transition-colors duration-200">
