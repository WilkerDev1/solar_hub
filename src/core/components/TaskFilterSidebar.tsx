...
export default function TaskFilterSidebar({
  ...
  const showDetailedFilters = 
    ...
    (setFilterProject !== undefined && projects.length > 0) || 
    (setFilterAssignee !== undefined && employees.length > 0) || 
    (setFilterPriority !== undefined) ||
    (setOnlyMyTasks !== undefined);
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-5 select-none scrollbar-none">
        ...
        {!sidebarCollapsed && showDetailedFilters && (
          <div className="space-y-3.5 pt-4 border-t border-zinc-700/60">
            ...
            <div className="px-3 space-y-3">
              ...
              {/* Project Filter */}
              {setFilterProject && projects.length > 0 && (
                <div className="space-y-1">
              ...
              {/* Assignee Filter */}
              {setFilterAssignee && employees.length > 0 && (
                <div className="space-y-1">
                  <label className="text-[9px] font-bold text-zinc-555 uppercase tracking-wider">Colaborador / Asignado</label>
                  <select
              ...
              {setOnlyMyTasks && onlyMyTasks !== undefined && (
