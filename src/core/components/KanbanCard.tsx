          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-1 mt-1">
              {((task as any).assigned_to_ids && (task as any).assigned_to_ids.length > 0
                ...
                if (!emp) return null;
                return (
                  <span key={i} className="inline-flex items-center bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-450 border border-emerald-500/25 px-2 py-0.5 rounded text-[9.5px] font-bold transition-colors">
