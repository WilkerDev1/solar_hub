      ...
      <div className="bg-zinc-950 border border-zinc-850 rounded-2xl w-full max-w-xl max-h-[90vh] flex flex-col shadow-2xl">
        ...
        <form onSubmit={handleCreateSubmit} className="p-6 overflow-y-auto space-y-4 text-left">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              ...
              <select
                ...
                className="w-full bg-zinc-900 border border-zinc-800 rounded-xl p-2.5 text-xs text-white focus:outline-none font-semibold"
              >
                <option value="">Sin vincular a obra (Huérfana)</option>
                {projects.map(p => (
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="space-y-1">
              <label className="text-[10px] font-bold text-zinc-555 uppercase font-mono">Prioridad</label>
              <select
            ...
            <div className="space-y-1">
              <label className="text-[10px] font-bold text-zinc-555 uppercase font-mono">Vencimiento</label>
              <input
                type="date"
          ...
          <div className="flex items-center gap-2.5 py-2">
            ...
            />
            <label htmlFor="create-requires-audit" className="text-xs font-bold text-zinc-455 cursor-pointer select-none">
