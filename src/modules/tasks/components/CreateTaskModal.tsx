          ...
          {showAdvanced && (
            <div className="pt-3 border-t border-[#2c2d34]/60 space-y-3">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <div className={`relative ${activePopover === 'project' ? 'z-40' : 'z-auto'}`}>
                  <button
                    type="button"
                    ...
                    <div className="absolute left-0 mt-1.5 w-64 bg-[#25262c] border border-[#3c3d47] rounded-xl p-3 shadow-2xl z-50 flex flex-col gap-2">
                      ...
                      <div className="max-h-40 overflow-y-auto space-y-1 pr-1 scrollbar-thin scrollbar-thumb-zinc-800">
                        <button
                          ...
                          className={`w-full text-left text-[11px] font-semibold p-2 hover:bg-[#2c2d34] rounded-lg block truncate ${
                            !createForm.project_id ? 'bg-[#2c2d34] text-emerald-400 font-bold' : 'text-zinc-400'
                          }`}
                        >
                        ...
                        {filteredProjects.map(proj => (
                          <button
                            ...
                            className={`w-full text-left text-[11px] font-semibold p-2 hover:bg-[#2c2d34] rounded-lg block truncate ${
                              createForm.project_id === proj.id ? 'bg-[#2c2d34] text-emerald-400 font-bold' : 'text-zinc-300'
                            }`}
                          >
                            {proj.name}
                          </button>
                ...
                {/* 4. Prioridad Button + Popover (right-aligned to fit layout) */}
                ...
                {/* 5. Vencimiento Button + Popover (right-aligned to fit layout) */}
                ...
                {/* 6. Opciones Button (Task type & requires audit) + Popover (right-aligned to grow inwards) */}
