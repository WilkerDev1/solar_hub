        ...
        <>
          ...
          {viewMode === 'kanban' && (
            <DragDropContext onDragEnd={onDragEnd}>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-[620px] items-stretch min-h-0">
                
                {/* Column: To Do */}
                <div className="bg-zinc-900/15 border border-zinc-900 rounded-2xl flex flex-col min-h-0 h-full p-4">
                  <div className="flex justify-between items-center mb-3.5 shrink-0 px-1">
                    <span className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest font-mono">Por Hacer</span>
                ...
                <div className="bg-zinc-900/15 border border-zinc-900 rounded-2xl flex flex-col min-h-0 h-full p-4">
                  <div className="flex justify-between items-center mb-3.5 shrink-0 px-1">
                    <span className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest font-mono">En Progreso</span>
                    <span className="bg-zinc-900 text-zinc-400 px-2 py-0.5 rounded text-[10px] font-bold font-mono">
                ...
                <div className="bg-zinc-900/15 border border-zinc-900 rounded-2xl flex flex-col min-h-0 h-full p-4">
                  <div className="flex justify-between items-center mb-3.5 shrink-0 px-1">
                    <span className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest font-mono">Finalizadas</span>
                    <span className="bg-zinc-900 text-zinc-400 px-2 py-0.5 rounded text-[10px] font-bold font-mono">
