    ...
    <div className="bg-white dark:bg-[#18181b] border-b border-zinc-200 dark:border-zinc-800 px-4 md:px-6 py-3 flex items-center justify-between shrink-0 h-14">
      <div className="flex items-center space-x-3">
        ...
        <button
          ...
          className="md:hidden h-9 w-9 flex items-center justify-center rounded-xl bg-zinc-100 dark:bg-zinc-800 text-zinc-650 hover:text-white transition-colors cursor-pointer"
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-zinc-800 dark:text-white text-sm tracking-wide">Caleb AI</span>
        </div>
      </div>
      ...
      <div className="flex items-center space-x-2">
        ...
        <span className="hidden sm:inline bg-zinc-100 dark:bg-zinc-850 px-2.5 py-1 rounded-md border border-zinc-200 dark:border-zinc-800 text-[10px] uppercase font-bold text-zinc-500">
          Terminal: /api/caleb
        </span>
        
        <div className="flex items-center space-x-1.5 bg-zinc-100 dark:bg-zinc-850 px-2.5 py-1 rounded-md border border-zinc-200 dark:border-zinc-800">
