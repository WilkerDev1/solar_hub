        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6 text-left [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-[#051424] [&::-webkit-scrollbar-thumb]:bg-[#3f465c] [&::-webkit-scrollbar-thumb]:rounded-full hover:[&::-webkit-scrollbar-thumb]:bg-[#adb4ce]">
          ...
          {activeTab === 'info' ? (
            <div className="space-y-6">
              ...
              {/* Image Section (Full Width style inside max-w-4xl) */}
              <div className="space-y-3.5">
                <div className="bg-[#122131] border border-[#334155] rounded-xl p-1 h-[320px] flex items-center justify-center relative overflow-hidden shadow-inner">
                  {resolvedMainImage ? (
                    <img 
              ...
              {/* Organized Grid of Information Cards below images */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                
                {/* 1. Stock e Inventario */}
                <div className="bg-[#122131] border border-[#334155] rounded-xl p-5 flex flex-col justify-between">
                  <div>
                ...
                {/* 5. Descripción (Spans full width on md/lg screens) */}
                <div className="bg-[#122131] border border-[#334155] rounded-xl p-5 md:col-span-2">
                  <h3 className="font-mono text-xs font-bold tracking-wider uppercase text-[#d3c5ac] mb-3 flex items-center gap-2">
